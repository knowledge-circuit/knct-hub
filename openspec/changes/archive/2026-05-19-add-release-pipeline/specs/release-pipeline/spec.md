...
- **WHEN** the user runs `uvx bump-my-version bump minor --config-file server/.bumpversion.toml`
...
- **WHEN** the user runs `uvx bump-my-version bump patch --config-file cli/.bumpversion.toml`
