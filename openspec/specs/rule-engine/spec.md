...
Match incoming hook events against per-project rules to decide which skills to inject. Supports path-glob matching and per-session dedupe with reset on context compaction.
